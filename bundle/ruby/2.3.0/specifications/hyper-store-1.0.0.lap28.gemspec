# -*- encoding: utf-8 -*-
# stub: hyper-store 1.0.0.lap28 ruby lib

Gem::Specification.new do |s|
  s.name = "hyper-store".freeze
  s.version = "1.0.0.lap28"

  s.required_rubygems_version = Gem::Requirement.new("> 1.3.1".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Mitch VanDuyn".freeze, "Adam Creekroad".freeze, "Jan Biedermann".freeze]
  s.bindir = "exe".freeze
  s.date = "2018-05-06"
  s.email = ["mitch@catprint.com".freeze, "jan@kursator.com".freeze]
  s.homepage = "https://ruby-hyperloop.org".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.12".freeze
  s.summary = "Flux Stores and more for Hyperloop".freeze
